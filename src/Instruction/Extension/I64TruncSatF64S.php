...
#[Opcode(ExtensionOpcode::i64_trunc_sat_f64_s)]
class I64TruncSatF64S implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: i64.trunc_sat_f64_s opcode');
    }
}