...
enum StandardOpcode: int implements Opcode {
    ...
    public static function readOpcode(string $input, int &$offset): InstructionInterface 
    {
        ...
        switch ($opcode) {
            case ExtensionOpcode::PREFIX:
                return ExtensionOpcode::readOpcode($input, $offset);
            case SimdOpcode::PREFIX:
                return SimdOpcode::readOpcode($input, $offset);
            // TODO
            default:
...
enum ExtensionOpcode: int implements Opcode {
...
// 0xfd simd codes
enum SimdOpcode: int implements Opcode {
...
interface InstructionInterface {
    public static function opCode(): Opcode;
