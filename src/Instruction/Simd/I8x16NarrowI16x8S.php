...
#[Opcode(SimdOpcode::i8x16_narrow_i16x8_s)]
class I8x16NarrowI16x8S implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: i8x16.narrow_i16x8_s opcode');
    }
}