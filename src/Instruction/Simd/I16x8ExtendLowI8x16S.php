...
#[Opcode(SimdOpcode::i16x8_extend_low_i8x16_s)]
class I16x8ExtendLowI8x16S implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i16x8.extend_low_i8x16_s opcode');
  }
}
