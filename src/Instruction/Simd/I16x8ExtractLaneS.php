...
#[Opcode(SimdOpcode::i16x8_extract_lane_s)]
class I16x8ExtractLaneS implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i16x8.extract_lane_s opcode');
  }
}
