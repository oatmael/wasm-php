...
#[Opcode(SimdOpcode::f32x4_extract_lane)]
class F32x4ExtractLane implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: f32x4.extract_lane opcode');
  }
}
