...
#[Opcode(SimdOpcode::i64x2_replace_lane)]
class I64x2ReplaceLane implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i64x2.replace_lane opcode');
  }
}
