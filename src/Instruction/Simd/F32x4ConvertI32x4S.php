...
#[Opcode(SimdOpcode::f32x4_convert_i32x4_s)]
class F32x4ConvertI32x4S implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: f32x4.convert_i32x4_s opcode');
    }
}