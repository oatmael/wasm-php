...
#[Opcode(SimdOpcode::i16x8_extend_high_i8x16_s)]
class I16x8ExtendHighI8x16S implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i16x8.extend_high_i8x16_s opcode');
  }
}
