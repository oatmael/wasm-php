...
#[Opcode(SimdOpcode::f32x4_demote_f64x2_zero)]
class F32x4DemoteF64x2Zero implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: f32x4.demote_f64x2_zero opcode');
    }
}