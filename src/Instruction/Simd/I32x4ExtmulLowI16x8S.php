...
#[Opcode(SimdOpcode::i32x4_extmul_low_i16x8_s)]
class I32x4ExtmulLowI16x8S implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: i32x4.extmul_low_i16x8_s opcode');
    }
}