...
#[Opcode(SimdOpcode::i16x8_q15mulr_sat_s)]
class I16x8Q15mulrSatS implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: i16x8.q15mulr_sat_s opcode');
    }
}