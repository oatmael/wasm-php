...
#[Opcode(SimdOpcode::i16x8_extend_high_i8x16_u)]
class I16x8ExtendHighI8x16U implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i16x8.extend_high_i8x16_u opcode');
  }
}
