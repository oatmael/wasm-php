...
#[Opcode(SimdOpcode::i64x2_extend_low_i32x4_s)]
class I64x2ExtendLowI32x4S implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: i64x2.extend_low_i32x4_s opcode');
    }
}