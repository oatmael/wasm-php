...
#[Opcode(SimdOpcode::i16x8_narrow_i32x4_s)]
class I16x8NarrowI32x4S implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i16x8.narrow_i32x4_s opcode');
  }
}
