...
#[Opcode(SimdOpcode::i32x4_extend_low_i16x8_s)]
class I32x4ExtendLowI16x8S implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i32x4.extend_low_i16x8_s opcode');
  }
}
