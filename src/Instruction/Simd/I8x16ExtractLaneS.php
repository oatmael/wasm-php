...
#[Opcode(SimdOpcode::i8x16_extract_lane_s)]
class I8x16ExtractLaneS implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i8x16.extract_lane_s opcode');
  }
}
