...
#[Opcode(SimdOpcode::i32x4_extmul_high_i16x8_u)]
class I32x4ExtmulHighI16x8U implements InstructionInterface {
    public static function fromInput(string $input, int &$offset): InstructionInterface {
        return new self();
    }

    public function execute(array &$stack, array &$call_stack, Store $store) {
        throw new Exception('Not implemented: i32x4.extmul_high_i16x8_u opcode');
    }
}