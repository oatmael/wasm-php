...
#[Opcode(SimdOpcode::f64x2_replace_lane)]
class F64x2ReplaceLane implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: f64x2.replace_lane opcode');
  }
}
