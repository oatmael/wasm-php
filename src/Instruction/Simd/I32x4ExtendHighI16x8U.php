...
#[Opcode(SimdOpcode::i32x4_extend_high_i16x8_u)]
class I32x4ExtendHighI16x8U implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i32x4.extend_high_i16x8_u opcode');
  }
}
