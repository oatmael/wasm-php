...
#[Opcode(SimdOpcode::f64x2_extract_lane)]
class F64x2ExtractLane implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: f64x2.extract_lane opcode');
  }
}
