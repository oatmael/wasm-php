...
#[Opcode(SimdOpcode::i64x2_extmul_low_i32x4_s)]
class I64x2ExtmulLowI32x4S implements InstructionInterface
{
  ...
  {
    throw new Exception('Not implemented: i64x2.extmul_low_i32x4_s opcode');
  }
}
